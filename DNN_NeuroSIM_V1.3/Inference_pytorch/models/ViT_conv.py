...
class MHA_(nn.Module):
    ...
    def forward(self, x):
        ...
        k_1 = k_1.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_2 = k_2.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_3 = k_3.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_4 = k_4.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_5 = k_5.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_6 = k_6.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_7 = k_7.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_8 = k_8.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_9 = k_9.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_10 = k_10.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_11 = k_11.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        k_12 = k_12.permute(2,1,0,3) # .reshape(self.N,self.Dh,1,1)
        ...
        Sc_1  = Sc_1.permute(2,1,0,3)#Sc_1.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_2  = Sc_2.permute(2,1,0,3)#Sc_2.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_3  = Sc_3.permute(2,1,0,3)#Sc_1.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_4  = Sc_4.permute(2,1,0,3)#Sc_2.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_5  = Sc_5.permute(2,1,0,3)#Sc_1.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_6  = Sc_6.permute(2,1,0,3)#Sc_2.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_7  = Sc_7.permute(2,1,0,3)#Sc_1.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_8  = Sc_8.permute(2,1,0,3)#Sc_2.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_9  = Sc_9.permute(2,1,0,3)#Sc_1.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_10 = Sc_10.permute(2,1,0,3)#Sc_2.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_11 = Sc_11.permute(2,1,0,3)#Sc_1.permute(1,0,2).reshape(self.N,self.N,1,1)
        Sc_12 = Sc_12.permute(2,1,0,3)#Sc_2.permute(1,0,2).reshape(self.N,self.N,1,1)
