...
assert args.model in ['VGG8', 'DenseNet40', 'ResNet18', 'ViT_linear',"ViT_conv_test","ViT_conv_imagenet","ViT_conv_cifar10"], args.model
if args.model == 'VGG8':
...
elif args.model == 'ViT_linear':
    from models import vit_linear
    modelCF = vit_linear.ViT(args=args, chw=(3,32,32), n_patches=2, n_block=1, num_classes=10, MLP_hidden=3072, logger=logger, N=768, head=2, D=768)
